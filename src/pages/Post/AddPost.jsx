          ...
          >
            {photos.map((photo, index) => (
              <div className="relative" key={index}>
                <button type="button" className="absolute -top-2 -right-2 bg-red-600 text-light-base p-1 rounded-full flex items-center justify-center shadow-md" onClick={() => setPhotos(photos.filter((_, i) => i !== index))}>
                  <svg className="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
